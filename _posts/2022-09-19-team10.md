...
In RL learning, we will encounter many complicated situations. In these situations, it may be difficult to achieve a good result if the machine alone is used to learn. So, in this project, we will explore human-AI shared control which can help to achieve better result than only used AI, and the method policy dissection used. We will apply the policy dissection method to the metadrive with PPO algorithm, so as to compare the results of PPO and PPO with policy dissection to determine whether policy dissection has improved the final result. In addition, we will recreate new actions to better simulate and display real-life situations.
...
![ppo demo1]({{ '/assets/images/team10/demo1.gif'| relative_url}}){: style="width: 200px; max-width: 100%;"}
*Fig 2. Demo 1*
![ppo demo2]({{ '/assets/images/team10/demo2.gif'| relative_url}}){: style="width: 200px; max-width: 100%;"}
*Fig 3. Demo 2*
![ppo demo2]({{ '/assets/images/team10/demo3.gif'| relative_url}}){: style="width: 200px; max-width: 100%;"}
*Fig 4. Demo 3*
...
![map1]({{ '/assets/images/team10/demo1.png'| relative_url}}){: style="width: 200px; max-width: 100%;"}
*Fig 5. road map 1*
![map2]({{ '/assets/images/team10/demo2.png'| relative_url}}){: style="width: 200px; max-width: 100%;"}
*Fig 6. road map 2*
![map3]({{ '/assets/images/team10/demo3.png'| relative_url}}){: style="width: 200px; max-width: 100%;"}
*Fig 7. road map 3*
...
### Demo
![demo of new action]({{ '/assets/images/team10/newaction.mov'| relative_url}}){: style="width: 400px; max-width: 100%;"}
